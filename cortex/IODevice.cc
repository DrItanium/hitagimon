...
namespace cortex
{
    namespace
    {
        ...
        volatile IOConfigurationSpaceView &
        getConfiguration0() {
    ...
    void
    ChipsetBasicFunctions::drawRoundedRect(uint16_t x, uint16_t y, uint16_t width, uint16_t height, uint16_t radius, uint16_t fgColor,
                                           bool fill) {
    ...
    void
    ChipsetBasicFunctions::drawLine(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t fgColor) {
        RawDisplayInstruction rdi(x0, y0, x1, y1, fgColor, 0, 0, 0);
        installInstruction0(rdi, InvokeOpcodes_DrawLine);
    }
    void
    ChipsetBasicFunctions::drawVerticalLine(uint16_t x, uint16_t y, uint16_t height, uint16_t fgColor) {
        RawDisplayInstruction rdi(x, y, height, fgColor, 0, 0, 0, 0);
        installInstruction0_FirstQuadField(rdi, InvokeOpcodes_DrawFastVLine);
    }
    void
    ChipsetBasicFunctions::drawHorizontalLine(uint16_t x, uint16_t y, uint16_t width, uint16_t fgColor) {
        RawDisplayInstruction rdi(x, y, width, fgColor, 0, 0, 0, 0);
        installInstruction0_FirstQuadField(rdi, InvokeOpcodes_DrawFastHLine);
    }

    void
    ChipsetBasicFunctions::drawTriangle(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint16_t fgColor,
                                        bool fill) {
