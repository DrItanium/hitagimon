/**
 * @file
 * Make dispatching on type in a variant via std::visit trivial
 * @copyright
 ...
 *
 */
#ifndef Neutron_Features_Overloaded_h__
#define Neutron_Features_Overloaded_h__
...
#endif // end Neutron_Features_Overloaded_h__
